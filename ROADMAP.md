...
- [x] **Ontology suggestion assist** *(initial shipped 2026-05-05)* — `tools/ontology-suggest/ep-ontology-suggest.py` proposes review-first category/entity suggestions from AKS records and existing graph edges. Maintainers accept/reject suggestions; no automatic ontology mutation.
